...
public class Video_63_Employee {
	...
	@JsonInclude(JsonInclude.Include.NON_DEFAULT)   //Here we are using JSON Include at property level
	private boolean married; 
	@JsonInclude(JsonInclude.Include.NON_EMPTY)     //Here we are using JSON Include at property level
